    ...
    <div>
        <section class="friendsTap">
            ...
            <div class="friendsBirthday" v-if="!searchValue">
                ...
                <birthday-friends v-for="(birthday, index) in birthdayList" :key="index" :birthday-index="index"></birthday-friends>
            </div>
            <div class="friends">
                <h2 class="friendsTitle">친구</h2>
                <friends-list v-for="(friend, index) in friendsList" :key="index" :friends-index="index" :search-value="searchValue"></friends-list>
            </div>
        </section>
    </div>
</template>
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            birthdayList() {
                return this.$store.state.birthdayList;
            }
        },
        data() {
            return {
